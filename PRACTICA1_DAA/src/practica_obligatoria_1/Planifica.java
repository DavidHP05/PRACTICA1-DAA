...
public class Planifica {
    public static void main(String[] args) throws IOException, FileNotFoundException {
        ...
        if(args.length==0){gestor.planificaConConsola();}
        if(args.length==1){gestor.planificaCon1Fichero(args[0]);}
        if(args.length==2){gestor.planificaConFicheros(args[0], args[1]);}
